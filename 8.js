...
var tecladoVirtualController = {
	...
	generarJson: function(tecladoAlfanum) {
		...
		if ( !tecladoAlfanum ){
			tecs = [
				{"id": "key_1", "label": "1", "sLabel": "!", "altLabel": "Â¡", "sAltLabel": "Â¹"},
				{"id": "key_2", "label": "2", "sLabel": "@", "altLabel": "Â²"},
				{"id": "key_3", "label": "3", "sLabel": "#", "altLabel": "Â³"},
				{"id": "key_4", "label": "4", "sLabel": "$", "altLabel": "Â¤", "sAltLabel": "Â£"},
				{"id": "key_5", "label": "5", "sLabel": "%", "altLabel": "â‚¬"},
				{"id": "key_6", "label": "6", "sLabel": "^", "altLabel": "Â¼", "sFunc": "deadcircumflex"},
				{"id": "key_7", "label": "7", "sLabel": "&", "altLabel": "Â½"},
				{"id": "key_8", "label": "8", "sLabel": "*", "altLabel": "Â¾"},
				{"id": "key_9", "label": "9", "sLabel": "(", "altLabel": "â€˜"},
				{"id": "key_0", "label": "0", "sLabel": ")", "altLabel": "â€™"}
		         ];
			...
			map = [
		            [
		             ...
		             {"id": "key_minus", "label": "?"},
		             {"id": "key_equals", "label": "Â¿", "sLabel": "Â¡"},
