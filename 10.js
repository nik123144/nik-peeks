 ...
 *  	validationsConfig:{json de configuraciÃ³n de validaciones},
 ...
 *            o puede no especificarse si no se trata de invocaciones asincrÃ³nicas
 * - loadCompleteFunction: Callback a invocar cuando vuelva la respuesta. Obligatorio
 * - validationsConfig: ConfiguraciÃ³n jquery.validate. Opcional
 * - customValidationFunction: FunciÃ³n de validaciÃ³n adicional. Seguir signatura de 
 ...
 function LinkTransactionController(options) {
	...
	function genericCallbackFunction(result, statusText) 
	{
		...
		if (json == null) {
	    	...
	    	// TODO Revisar si aquÃ­ entran los errores de validaciÃ³n del servidor
